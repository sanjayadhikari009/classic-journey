...
<head>
    ...
    <title>Create Account - Classic Journeys</title>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="username" name="username" type="text" required autofocus autocomplete="username"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#1e3a8a] focus:border-[#1e3a8a] placeholder-gray-400 text-gray-900"
                    ...
                    <div>
                        <button type="submit" 
                                class="w-full py-3 rounded-lg font-bold text-white bg-[#1e3a8a] hover:bg-[#1e40af] shadow transition">
                            Register
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="font-medium text-[#1e3a8a] hover:text-[#1e40af]">
                            Sign in here
                        </a>
                    </p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Why join Classic Journeys?</h3>
                <div class="space-y-3">
